        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-secondary"><span class="text-primary">Di</span>Laundry in Aja</h1>
                </a>
        ...
        <div class="container pt-0 pt-lg-4">
            ...
            <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5" id="contact">
                <div class="row pt-5">
                    <div class="col-lg-5 col-md-5 mb-5">
                        <a href="">
                            <h1 class="text-secondary mb-3"><span class="text-white">Di</span>Laundry in Aja</h1>
                        </a>
            ...
            <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
                <p class="m-0 text-center text-white">
                    &copy; <a class="text-white font-weight-medium" href="#">Laundry in Aja</a>..

                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed by <a class="text-white font-weight-medium" >Mey</a>
                </p>
            </div>
            <!-- Footer End -->
