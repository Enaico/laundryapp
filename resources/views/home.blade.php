...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-light">{{ __('Dashboard') }}</h1>
    ...
    <div class="row">
        <div class="col-md-3 col-12">
            <a href="{{ url('/home/generate-data') }}" class="btn btn-primary mb-2" style="background-color: #5052a2; color: white;">Cetak Data</a>
        </div>
        <div class="col-12">
