...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-light">{{ __('Profile') }}</h1>
        ...
        <div class="col-lg-4 order-lg-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-profile-image mt-4">
                    <figure class="center rounded-circle avatar avatar font-weight-bold" style="font-size: 60px; height: 180px; width: 180px;" data-initial="{{ Auth::user()->name[0] }}"></figure>
                </div>
                <div class="card-body">
